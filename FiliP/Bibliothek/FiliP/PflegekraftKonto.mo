...
protected
  ...
  parameter Real UrlaubStartTermine[:] = {10, 20, 30} "number of input places" annotation(
    Dialog(enable = true, group = "Urlaubs Daten"));
  ...
  PNlib.PN.Components.PC ArbeitszeitKontingent(nInDis = 1, nOutDis = 1 + AnzahlSchichten * 2, startTokens = 4 * VKstundenWoche * Stelle) annotation(
  ...
  PNlib.PN.Components.TD ArbeitszeitGeber( arcWeightOutCon = {4 * VKstundenWoche * Stelle}, nOutCon = 1, timeType = PNlib.Types.TimeType.Tact, timeValue = {28, 28}) annotation(
  ...
  FiliP.Urlaub urlaub(UrlaubEndTermine = UrlaubEndTermine, UrlaubStartTermine = UrlaubStartTermine) annotation(
...
//Schicht 1
  ...
  connect(ArbeitszeitKontingent.outTransitionDis[3], schicht1.ArbeitszeitIn[2]) annotation(
    Line(points = {{-248, 130}, {-20, 130}, {-20, 198}, {6, 198}, {6, 198}}, thickness = 0.5));
  connect(ArbeitszeitKontingent.outTransitionDis[2], schicht1.ArbeitszeitIn[1]) annotation(
    Line(points = {{-248, 130}, {-20, 130}, {-20, 198}, {6, 198}, {6, 198}}, thickness = 0.5));
...
//Schicht 2
  ...
  connect(ArbeitszeitKontingent.outTransitionDis[5], schicht2.ArbeitszeitIn[2]);
  connect(ArbeitszeitKontingent.outTransitionDis[4], schicht2.ArbeitszeitIn[1]);
...
//Schicht 3
  ...
  connect(ArbeitszeitKontingent.outTransitionDis[7], schicht3.ArbeitszeitIn[2]);
  connect(ArbeitszeitKontingent.outTransitionDis[6], schicht3.ArbeitszeitIn[1]);
...
//Schicht 4
  ...
  connect(ArbeitszeitKontingent.outTransitionDis[9], schicht4.ArbeitszeitIn[2]);
  connect(ArbeitszeitKontingent.outTransitionDis[8], schicht4.ArbeitszeitIn[1]);
...
//Schicht 5
  ...
  connect(ArbeitszeitKontingent.outTransitionDis[11], schicht5.ArbeitszeitIn[2]);
  connect(ArbeitszeitKontingent.outTransitionDis[10], schicht5.ArbeitszeitIn[1]);
...
//Schicht 6
  ...
  connect(ArbeitszeitKontingent.outTransitionDis[13], schicht6.ArbeitszeitIn[2]);
  connect(ArbeitszeitKontingent.outTransitionDis[12], schicht6.ArbeitszeitIn[1]);
...
// Weiter Conectoren
  connect(ZeitVernichter.inPlacesCon[1], ArbeitszeitKontingent.outTransitionDis[1]) annotation(
