within PNlib.PN.Examples.Models.FiliP.PNerweiterungen;
model PDwkeit "Discrete Place"
  ...
  Real enablingProbIn[nInDis]=fill(1/nInDis, nInDis)
  ...
  Real enablingProbOut[nOutDis]=fill(1/nOutDis, nOutDis)
