...
extends Modelica.Icons.Example;
  PNlib.PN.Components.PC P1(enablingType = PNlib.Types.EnablingType.Probability, localSeedIn = 1, localSeedOut = 2,nInDis = 1, nOutDis = 2, startTokens = 2) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  ...
  PNlib.PN.Components.PD P2(localSeedIn = 3, localSeedOut = 4, nInDis = 1)  annotation(Placement(transformation(extent = {{30, 10}, {50, 30}})));
  PNlib.PN.Components.PD P3(localSeedIn = 5, localSeedOut = 6, nInDis = 1)  annotation(Placement(transformation(extent = {{30, -30}, {50, -10}})));
...
equation
  ...
  connect(P1.outTransitionDis[2], T2.inPlacesCon[1]) annotation(
    Line(points = {{-12, -8}, {-2, -8}, {-2, -30}, {6, -30}, {6, -28}}, thickness = 0.5));
