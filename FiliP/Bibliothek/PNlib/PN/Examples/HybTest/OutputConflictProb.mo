...
extends Modelica.Icons.Example;
  PNlib.PN.Components.PC P1(enablingType = PNlib.Types.EnablingType.Probability, localSeedIn = 1, localSeedOut = 2, minTokens=2,nInDis = 1, nOutDis = 2, startTokens=4) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
