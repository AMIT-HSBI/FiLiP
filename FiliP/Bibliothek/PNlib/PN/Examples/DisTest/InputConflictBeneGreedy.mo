...
model InputConflictBeneGreedy
  ...
  PNlib.PN.Components.PD P1(enablingBeneIn = {1, 2},enablingType = PNlib.Types.EnablingType.Benefit, maxTokens = 2, nInDis = 2, nOutDis = 1) annotation(Placement(transformation(extent={{10, -10},
            {30, 10}})));
