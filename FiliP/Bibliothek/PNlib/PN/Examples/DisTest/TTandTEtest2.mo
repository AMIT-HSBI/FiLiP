...
model TTandTEtest2
  ...
  PNlib.PN.Components.PD P2( enablingPrioOut = {2, 1},nOutDis = 2, startTokens = 3)  annotation(
  ...
  PNlib.PN.Components.TD T4( nInDis = 1, nOutDis = 1, timeType = PNlib.Types.TimeType.Event, timeValue = {1, 2})  annotation(
...
equation
  connect(T4.inPlacesDis[1], P2.outTransitionDis[2]) annotation(
    Line(points = {{-12.8, -22}, {-20.6, -22}, {-20.6, -2}, {-28.6, -2}}, thickness = 0.5));
  connect(T4.outPlacesDis[1], P4.inTransitionDis[1]) annotation(
    Line(points = {{-3.2, -22}, {4.8, -22}}, thickness = 0.5));
