...
model TDSuniform
  ...
  PNlib.PN.Components.TS T1(a = 2, b = 4, distributionType = PNlib.Types.DistributionType.Uniform,localSeed=1, nInDis=1, nOutDis=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}})));
equation
