...
model DoubleArcwithPTtoTD2
 extends Modelica.Icons.Example;
  ...
  PNlib.PN.Components.EA EA1(Arc = PNlib.Types.ArcType.InhibitorArc, testValue = 3) annotation(Placement(visible = true, transformation(extent = {{-24, 38}, {-12, 42}}, rotation = 0)));
  ...
  PNlib.PN.Components.EA EA2(Arc = PNlib.Types.ArcType.TestArc, testValue = 2) annotation(Placement(visible = true, transformation(extent = {{-20, -22}, {-6, -16}}, rotation = 0)));
