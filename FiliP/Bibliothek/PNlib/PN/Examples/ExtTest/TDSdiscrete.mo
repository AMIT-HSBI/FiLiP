...
model TDSdiscrete
  ...
  PNlib.PN.Components.PD P1(nOutDis=1, startTokens= 18) annotation(Placement(transformation(extent={{-40, -10}, {-20, 10}})));
  PNlib.PN.Components.PD P2(nInDis=1) annotation(Placement(transformation(extent={{20, -10}, {40, 10}})));
  PNlib.PN.Components.TS T1(distributionType = PNlib.Types.DistributionType.Discrete,localSeed=1, nInDis=1, nOutDis=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}})));
equation
