...
model IATest
  ...
  PNlib.PN.Components.PC P1( nInCon=1,nOutCon=2, nOutExt = 1, startTokens = 2) annotation(Placement(transformation(extent={{-70, -10}, {-50, 10}})));
  PNlib.PN.Components.PC P2(nInCon=1, nOutExt=1, startTokens = 1) annotation(Placement(transformation(extent={{10, -10}, {30, 10}})));
  ...
  PNlib.PN.Components.TC T3( arcWeightInCon={ 2}, maximumSpeed = 2,nInCon= 1, nInExt = 1, nOutCon=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}}, rotation=0, origin={80, 0})));
equation
