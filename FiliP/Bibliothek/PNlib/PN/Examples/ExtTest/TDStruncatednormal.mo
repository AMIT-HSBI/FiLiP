...
model TDStruncatednormal
  ...
  PNlib.PN.Components.TS T1( distributionType = PNlib.Types.DistributionType.TruncatedNormal,localSeed=1, nInDis=1, nOutDis=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}})));
equation
