...
block enablingOutConProb "enabling process of output transitions"
        ...
        TEout := TAout;
          ...
          if nTAout>0 then
            ...
            for i in 1:nTAout loop
              ...
              if ((t-arcWeightSum-arcWeight[posTE]-minTokens>=-PNlib.Constants.almost_eps) or PNlib.Functions.OddsAndEnds.isEqual(arcWeight[i], 0.0)) then
